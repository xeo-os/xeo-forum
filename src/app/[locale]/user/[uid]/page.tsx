    ...
    ...likes.map((like) => ({
      ...
      content: {
        post: like.post
          ...
          : undefined,
        reply: like.reply
          ? { id: like.reply.id, content: like.reply.content }
          : undefined,
      },
    })),
    ...
    <main className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <Card className="mb-8 relative overflow-hidden">
        ...
        <CardHeader className="relative z-10">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-white/90 mb-2 drop-shadow-sm">
                @{user.username}
              </p>
              <Badge
                variant={
        ...
        <CardContent className="relative z-10">
          {user.bio && (
            <p className="text-base mb-4 text-white drop-shadow-sm">
              {user.bio}
            </p>
          )}
