    ...
    const timeline = [
        {
            ...
            description: lang(
                {
                    'zh-CN': '2025/06/09,开始构建全球首个AI驱动的多语言论坛平台',
                    'en-US': 'June 9, 2025, began building the world\'s first AI-driven multilingual forum platform',
                    'ja-JP': '2025/06/09、世界初のAI駆動多言語フォーラムプラットフォームの構築を開始',
                    'ko-KR': '2025/06/09, 세계 최초의 AI 기반 다국어 포럼 플랫폼 구축 시작',
                    'fr-FR': '9 juin 2025, a commencé à construire la première plateforme de forum multilingue pilotée par l\'IA au monde',
                    'es-ES': '9 de junio de 2025, comenzó a construir la primera plataforma de foro multilingüe impulsada por IA del mundo',
                    'de-DE': '9. Juni 2025, begann mit dem Aufbau der weltweit ersten KI-gesteuerten mehrsprachigen Forumsplattform',
                    'pt-BR': '9 de junho de 2025, começou a construir a primeira plataforma de fórum multilíngue movida por IA do mundo',
                    'ru-RU': '9 июня 2025, начал создание первой в мире многоязычной форумной платформы на основе ИИ',
                    'zh-TW': '2025/06/09，開始構建全球首個AI驅動的多語言論壇平台',
                },
                locale,
            ),
        },
        {
            ...
            title: lang(
                {
                    'zh-CN': '内测开始',
                    'en-US': 'Beta Testing Begins',
                    'ja-JP': 'ベータテスト開始',
                    'ko-KR': '베타 테스트 시작',
                    'fr-FR': 'Début des tests bêta',
                    'es-ES': 'Inicio de pruebas beta',
                    'de-DE': 'Beta-Tests beginnen',
                    'pt-BR': 'Início dos Testes Beta',
                    'ru-RU': 'Начало бета-тестирования',
                    'zh-TW': '內測開始',
                },
                locale,
            ),
            description: lang(
                {
                    'zh-CN': '2025/06/17,开始小范围的内测',
                    'en-US': 'June 17, 2025, started small-scale beta testing',
                    'ja-JP': '2025/06/17、小規模なベータテストを開始',
                    'ko-KR': '2025/06/17, 소규모 베타 테스트 시작',
                    'fr-FR': '17 juin 2025, début des tests bêta à petite échelle',
                    'es-ES': '17 de junio de 2025, comenzaron las pruebas beta a pequeña escala',
                    'de-DE': '17. Juni 2025, Beginn der kleineren Beta-Tests',
                    'pt-BR': '17 de junho de 2025, iniciaram os testes beta em pequena escala',
                    'ru-RU': '17 июня 2025, начало небольшого бета-тестирования',
                    'zh-TW': '2025/06/17，開始小範圍的內測',
                },
                locale,
            ),
        },
        {
            ...
            title: lang(
                {
                    'zh-CN': '公测上线',
                    'en-US': 'Public Beta Launch',
                    'ja-JP': 'パブリックベータ開始',
                    'ko-KR': '공개 베타 출시',
                    'fr-FR': 'Lancement de la bêta publique',
                    'es-ES': 'Lanzamiento de beta pública',
                    'de-DE': 'Öffentliche Beta-Veröffentlichung',
                    'pt-BR': 'Lançamento da Beta Pública',
                    'ru-RU': 'Запуск публичной беты',
                    'zh-TW': '公測上線',
                },
                locale,
            ),
            description: lang(
                {
                    'zh-CN': '2025/06/26,正式对外开放注册和使用',
                    'en-US': 'June 26, 2025, officially opened registration and usage to the public',
                    'ja-JP': '2025/06/26、正式に一般公開で登録と利用を開始',
                    'ko-KR': '2025/06/26, 공식적으로 대중에게 등록 및 사용 개방',
                    'fr-FR': '26 juin 2025, ouverture officielle de l\'inscription et de l\'utilisation au public',
                    'es-ES': '26 de junio de 2025, abrió oficialmente el registro y uso al público',
                    'de-DE': '26. Juni 2025, offizielle Öffnung von Registrierung und Nutzung für die Öffentlichkeit',
                    'pt-BR': '26 de junho de 2025, abriu oficialmente o registro e uso para o público',
                    'ru-RU': '26 июня 2025, официально открыт доступ для регистрации и использования',
                    'zh-TW': '2025/06/26，正式對外開放註冊和使用',
                },
                locale,
            ),
        },
        {
            ...
            title: lang(
                {
                    'zh-CN': '用户数量达到10000',
                    'en-US': 'Reached 10,000 Users',
                    'ja-JP': 'ユーザー数10,000人達成',
                    'ko-KR': '사용자 수 10,000명 달성',
                    'fr-FR': 'Atteint 10 000 utilisateurs',
                    'es-ES': 'Alcanzó 10,000 usuarios',
                    'de-DE': '10.000 Nutzer erreicht',
                    'pt-BR': 'Alcançou 10.000 usuários',
                    'ru-RU': 'Достигли 10,000 пользователей',
                    'zh-TW': '用戶數量達到10000',
                },
                locale,
            ),
            description: lang(
                {
                    'zh-CN': '2025/07/22,总用户数达到10000',
                    'en-US': 'July 22, 2025, total user count reached 10,000',
                    'ja-JP': '2025/07/22、総ユーザー数が10,000人に到達',
                    'ko-KR': '2025/07/22, 총 사용자 수가 10,000명에 도달',
                    'fr-FR': '22 juillet 2025, le nombre total d\'utilisateurs a atteint 10 000',
                    'es-ES': '22 de julio de 2025, el número total de usuarios alcanzó 10,000',
                    'de-DE': '22. Juli 2025, Gesamtnutzerzahl erreichte 10.000',
                    'pt-BR': '22 de julho de 2025, o número total de usuários atingiu 10.000',
                    'ru-RU': '22 июля 2025, общее количество пользователей достигло 10,000',
                    'zh-TW': '2025/07/22，總用戶數達到10000',
                },
                locale,
            ),
        },
