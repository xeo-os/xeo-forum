  ...
  const title = lang(
    {
      ...
      "fr-FR":
        "Politique de confidentialité | XEO OS - Échanger les opinions de chacun",
      "es-ES":
        "Política de privacidad | XEO OS - Intercambiar las opiniones de todos",
...
export default async function PrivacyPolicyPage({ params }: Props) {
  ...
  const languageNotice = lang(
    {
      "zh-CN":
        "本隐私政策以中文编写，具有法律效力。为确保准确性，我们不提供翻译版本。",
      "en-US":
      ...
      "zh-TW":
        "本隱私政策以中文編寫，具有法律效力。為確保準確性，我們不提供翻譯版本。",
    },
    locale
  );
