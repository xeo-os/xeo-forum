            ...
            message: langs(
                {
                    ...
                    'ru-RU': 'Имя пользователя, пароль и электронная почта не могут быть пустыми',
            ...
            message: langs(
                {
                    ...
                    'es-ES': 'Formato inválido para nombre de usuario, contraseña o correo',
                    'fr-FR': "Format invalide pour nom d'utilisateur, mot de passe ou email",
                    'ru-RU': 'Неверный формат имени пользователя, пароля или электронной почты',
                    'ja-JP': 'ユーザー名、パスワード、またはメールアドレスの形式が無効です',
            ...
            message: langs(
                {
                    ...
                    'fr-FR': "Le nom d'utilisateur doit contenir entre 3 et 20 caractères",
