                  ...
                  {isLoggedIn ? (
                    <AvatarImage
                      src={`/api/dynamicImage/emoji?emoji=${encodeURIComponent(
                        ...
                        userData.avatar?.background?.replaceAll("%", "%25") ||
                          ""
                      )}`}
                    />
                  ) : (
                      ...
                      <div className="flex flex-col space-y-1">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <span className="text-xs">
                            Lv.{Math.floor((userData.userExp || 0) / 100)}
                          </span>
                          <Progress
                            value={expProgress}
                    ...
                    <DropdownMenuLabel>
                      <div className="flex flex-col space-y-1">
                        ...
                        <p className="text-xs leading-none text-muted-foreground">
                          {lang(
                            {
                              "en-US": "Please login to access more features",
                              "zh-CN": "请登录以访问更多功能",
                              "zh-TW": "請登入以訪問更多功能",
                              "es-ES":
                              ...
                              "pt-BR": "Faça login para acessar mais recursos",
                              "ko-KR":
              ...
              {lang(
                {
                  ...
                  "zh-CN":
                    "您确定要退出登录吗？您需要重新登录才能访问您的账户。",
                  "zh-TW":
                    "您確定要退出登入嗎？您需要重新登入才能訪問您的帳戶。",
                  "es-ES":
