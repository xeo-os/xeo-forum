                                ...
                                {lang(
                                    {
                                        ...
                                        'es-ES':
                                            'Comparte tu primera publicación para comenzar la conversación',
                                        'fr-FR':
                                            'Partagez votre premier post pour commencer la conversation',
                                        'ru-RU':
                                            'Поделитесь своим первым постом, чтобы начать общение',
                                        'ja-JP': '最初の投稿を共有して会話を始めましょう',
                                        'de-DE':
                                            'Teilen Sie Ihren ersten Beitrag, um das Gespräch zu beginnen',
                                        'pt-BR':
                                            'Compartilhe sua primeira postagem para iniciar a conversa',
