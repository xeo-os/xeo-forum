            ...
            message: lang(
              {
                ...
                "ko-KR":
                  "사용자 이름은 소문자, 숫자 및 밑줄만 포함할 수 있습니다",
              },
              locale
            ),
          },
            ...
            : lang(
                {
                  ...
                  "de-DE":
                    "Das Passwort muss zwischen 5 und 50 Zeichen lang sein",
          ...
          lang(
            {
              ...
              "zh-TW": "發生網路錯誤，請重試。",
              "es-ES":
                "Ocurrió un error de red. Por favor, inténtalo de nuevo.",
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <Dialog
        ...
        onOpenChange={setIsApiErrorDialogOpen}
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="text-red-600">
